...
// dapat mengatur nilai default pada construct
	Public function __construct( $judul="unknown", $penulis="unknown", $penerbit="unknown", $harga=0, $jmlHal=0, $waktuMain=0 ) {
		$this->judul = $judul;
...
$produk1 = new Komik("Code Geass", "Sunrise", "Sunrise", 25000, 100, 0);
$produk2 = new Game("Fate Grand Order", "TYPE-MOON", "Delight Works", 0, 0, 24);
